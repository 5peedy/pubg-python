...
class Rankedplayerstats(Domain):
    ...
    def from_dict(self):
        super().from_dict()
        all_stats = self.attributes.get('rankedGameModeStats').get('All')
        ...
        self.rounds_played = all_stats.get('roundsPlayed')
        self.avg_rank = all_stats.get('avgRank')
        self.top_10_ratio = all_stats.get('top10Ratio')
        self.win_ratio = all_stats.get('winRatio')
        self.assists = all_stats.get('assists')
        self.wins = all_stats.get('wins')
        self.kda = all_stats.get('kda')
        self.kills = all_stats.get('kills')
        self.deaths = all_stats.get('deaths')
        self.damage_dealt = all_stats.get('damageDealt')
        self.dBNOs = all_stats.get('dBNOs')
